...
<a class="nav-item logo" ${
	nav_id.className === 'navbar-main' ? '' : "href='../'"
}>
    <img src="https://avatars.githubusercontent.com/u/22519967" alt="SmolAlli">
</a>

<!-- BetterDiscord logo --> 
<a href="${
	nav_id.className === 'navbar-main' ? '.' : '..'
}/BetterDiscord/#home" class="nav-item">
    ...
    <span class="link-text">BetterDiscord</span>
</a>

<!-- Discord logo -->
<a href="${
	nav_id.className === 'navbar-main' ? '.' : '..'
}/discord.html" target="_blank" rel="noopener noreferrer" class="nav-item">
    <svg viewBox="-3 -10 75 75">
...
<!-- Github logo -->
<a href="https://github.com/SmolAlli/" class="nav-item" target="_blank" rel="noopener noreferrer">
