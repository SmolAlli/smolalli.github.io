...
> • You should also make sure that "Memory size" is set to 8gb, to make sure that Usamune works.

<div style="text-align: center;">

![Input configuration page](/img/rmg-settings-core.png)

</div>

• In the plugins tab, the video plugin should be "GLideN64".

• In the plugins tab, select the correct input plugin for which controller you are using. Details found [here](./plugins).

<div style="text-align: center;">

![Input configuration page](/img/rmg-settings-plugins.png)

</div>

That should be just about it for setting up the emulator! Have a look at the hotkeys tab in settings and make sure you are familiar with the hotkeys you may need (e.g. `F1` for reset).
