...
const zerezoom2 = document.querySelectorAll(
	'[class^="userName" i], .title-29uC1r, .topic-TCb_qw, .roleColor-rz2vM0, .name-1jkAdW, .channelName-2YrOjO, .overflow-WK9Ogt, .markup-2BOw-j, .textContent-3N7xXx'
);
